...
export default function FriendsPage() {
    ...
    return (
        <div className="flex justify-center p-8 min-h-screen text-white">
            <div className="min-w-[600px] w-full max-w-3xl rounded-xl overflow-hidden shadow-lg bg-githubDark text-left p-6 space-y-8">
